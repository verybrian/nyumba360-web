  ...
  <div class="tenants">
    <div class="header">
      ...
      <div class="header-right">
        ...
        <div class="filters-wrapper" v-click-outside="() => (filtersOpen = false)">
    ...
    <div v-else-if="fetchError" class="error-cell">
      {{ fetchError }} <button @click="fetchTenants">Retry</button>
    </div>
...
const deleteSelected = async () => {
  ...
  try {
    ...
    fetchError.value = 'Bulk delete failed. Please try again.'
  }
}
...
const fetchTenants = async () => {
  ...
  fetchError.value = ''
  try {
    const res = await apiFetch(`/api/properties/${props.propertyId}/tenants/`)
    if (!res.ok) {
...
<style scoped src="../../../styles/pages/property/tenants.css"></style>
